<template>
  <div>
    <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 1119.60911 699" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <path d="M140.09162,291.85056c0-78.36865,54.255-141.78356,121.30372-141.78356" transform="translate(-31.39089 -100.5)" :fill="color"/>
      <path d="M70.77521,158.66768c0,73.61476,31.00285,133.18288,69.31641,133.18288" transform="translate(-31.39089 -100.5)" :fill="color"/>
      ...
      <rect x="271.60911" y="150" width="16" height="16" :fill="color" opacity="0.4"/>
      <rect x="294.60911" y="150" width="16" height="16" :fill="color" opacity="0.8"/>
      <rect x="317.60911" y="150" width="16" height="16" :fill="color"/>
      <rect x="271.60911" y="251" width="16" height="16" :fill="color" opacity="0.4"/>
      <rect x="294.60911" y="251" width="16" height="16" :fill="color" opacity="0.8"/>
      <rect x="317.60911" y="251" width="16" height="16" :fill="color"/>
      <rect x="271.60911" y="352" width="16" height="16" :fill="color" opacity="0.4"/>
      <rect x="294.60911" y="352" width="16" height="16" :fill="color" opacity="0.8"/>
      ...
      <path d="M271.36733,565.03228c-6.37889-28.56758,14.01185-57.43392,45.544-64.47477s62.2651,10.41,68.644,38.9776-14.51861,39.10379-46.05075,46.14464S277.74622,593.59986,271.36733,565.03228Z" transform="translate(-31.39089 -100.5)" :fill="color"/>
